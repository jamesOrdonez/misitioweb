...
//creamos las variables de tipo date para las horas de salida y de llegada
    let horaSalida1 = new Date(2022, 12, 11, 8, 20, 0);
    let horaLlegada1 = new Date(2022, 12, 11, 10, 20, 0);
    let horaSalida1Str = definirJornada(horaSalida1);
    let horaLlegada1Str = definirJornada(horaLlegada1);

    let horaSalida2 = new Date(2022, 2, 12, 8, 30, 0);
    let horaLlegada2 = new Date(2022, 2, 12, 9, 40, 0);
